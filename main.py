...
Задание 2: [Задание 1] + сумма цифр должна быть двузначной иметь ровно одну четную цифру в записи. Целевая функция это числа с максимальным значением суммы цифр по модулю 7.
'''
